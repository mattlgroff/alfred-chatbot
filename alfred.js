...
var JefNode = require('json-easy-filter').JefNode; //Easy filtering of massive .json trees from Destiny API
var mcping = require('mc-ping'); //Easy pinging package w/ data request for Minecraft servers
var express = require('express');

//Variables!
var url //Placeholder value for HTTP requests URLs.
...
request(options, function(err, res, body){ 
        ...
        request(auth, function(err, res, body){   //Beginning of Auth Request to get URL for Websocket
                ...
                ws.on('message', (packet, flags) => {
						...
						console.log(packet.d.user.username + "'s Pocket: " + packet);
                        ...
                        switch (packet.t) {
                                ...
                                function describeItem (itemNumber) {
                                        ...
                                        if(message.indexOf("minecraft down") > -1 || message.indexOf("Is the minecraft server down?") > -1 || message.indexOf("minecraft down?") > -1) {
												...
												mcping(host, 25565, function(error, res) { //Vanilla Server IP/Port
												if (error){
													console.log(res)
												...
												mcping(host, 25566, function(error, res) { //Mod Server IP/Port
												if (error){
													console.log(res)
													console.log (host + ": " + error.toString ())
                ...
                }) //End of case statements for Discord bot response triggers.
        })  //End of Auth Request to get URL for Discord Websocket
})  //Ending of Discord Request
